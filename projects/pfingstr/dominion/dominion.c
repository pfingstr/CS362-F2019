...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
    ...
    {
    case ambassador:
    refactoredAmbassador(state, choice1, choice2, currentPlayer, handPos);

    case baron:
        refactoredBaron(state, choice1, currentPlayer);

    case mine:
        refactoredMine(state, choice1, choice2, currentPlayer, handPos);

    case minion:
        refactoredMinion(state, choice1, choice2, currentPlayer, handPos);

    case tribute:
        refactoredTribute(state, currentPlayer);
